...
def build_arranged_preview_controls(app: "App", parent: ttk.Frame, side: str) -> None:
    ...
    view_box = ttk.LabelFrame(parent, text="View")
    view_box.pack(fill="x")

    height_row = ttk.Frame(view_box)
    ...
    metronome_row = ttk.Frame(playback_box)
    ...
    action_row = ttk.Frame(playback_box)
    ...
    loop_box = ttk.LabelFrame(parent, text="Loop")
    ...
    loop_button_row = ttk.Frame(loop_box)
    ...
    transpose_box = ttk.LabelFrame(parent, text="Manual transpose")
    transpose_box.pack(fill="x", pady=(12, 0))

    semitone_row = ttk.Frame(transpose_box)
    semitone_row.pack(fill="x", pady=(6, 0))
    ttk.Label(semitone_row, text="Semitones").pack(side="left")

    control_row = ttk.Frame(transpose_box)
    ...
    transpose_actions = ttk.Frame(transpose_box)
